...
namespace Hello_DataSets
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            DB_work mywrk = new DB_work(@"Data Source=ASUS-VIVOBOOK-P\SASHASQLSERVER;Initial Catalog=DataSetDB;Integrated Security=True");
            mywrk.DB_conn();
            ...
            mywrk.Courses_Update("courses", "course_id", "C12", "begin_date", "2014-01-06");
            ...
            mywrk.Courses_Update_ds("courses", "course_id", "C12", "begin_date", "2013-01-01");
            ...
            mywrk.Courses_Update_bldr("courses", "course_id", "C12", "begin_date", "2012-01-01");
